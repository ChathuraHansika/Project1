...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/Resources/js/adminhomejs/jquery-3.2.1.min.js"></script>
    <script>
                        ...
                        <div class="dropdown-menu top-grid-scroll drop-1">
                            ...
                            <a href="#" class="dropdown-item mt-3">
                                <div class="notif-img-agileinfo">
                                    <img src="${contextPath}/Resources/images/adminhomeimages/images/clone.jpg" class="img-fluid" alt="Responsive image">
                                </div>
                        ...
                        <div class="dropdown-menu drop-3">
                            <div class="profile d-flex mr-o">
                                <div class="profile-l align-self-center">
                                    <img src="${contextPath}/Resources/images/adminhomeimages/images/profile.jpg" class="img-fluid mb-3" alt="Responsive image">
                                </div>
                ...
                <form>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label >State</label>
                            <select id="BrandData" class="form-control" onchange="getCarModel()">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label ></label>
                            <input type="text" class="form-control" id="NewBrandInputText" placeholder="New Brand">
                        </div>
                        <div class="form-group col-md-6">
                            <label ></label>
                            <input type="text" class="form-control" id="NewBrandinutText" placeholder="New Model">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="VehicleNoText" placeholder="VehicleNo">
                        </div>
                        <div class="form-group col-md-4">

                            <label >Gear Type</label>
                            <select id="GearType" class="form-control">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <label >Luggage</label>
                            <select id="Luggege" class="form-control">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="Passenegers" class="form-control">
                                <option selected>2</option>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="ManufactureYear" placeholder="Doors">
                        </div>
                        <div class="form-group col-md-4">

                            <label >AirBags</label>
                            <select id="AirBags" class="form-control">
                                <option selected>2</option>
                                <option selected>4</option>
                                <option selected>6</option>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="WheelType" class="form-control">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="StartType" class="form-control">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select id="Steering Wheel Type" class="form-control">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="Power Mirror" class="form-control">
                                <option selected>Yes</option>
                                <option >No</option>
                                <!--<option>New Model</option>-->
                            </select>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="Power Shutter" class="form-control">
                                <option selected>Yes</option>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select id="No of Sheets" class="form-control">
                                <option selected>2</option>
                                <option selected>4</option>
                                <option selected>6</option>
                                <option selected>8</option>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="Licence Date" placeholder="Doors">
                        </div>

                        <div class="form-group col-md-4">
                            <label>Insurance Date</label>
                            <select id="Insurance Date" class="form-control">
                                <option selected>Choose Start Type</option>
                                <!--<option>New Model</option>-->
                            </select>
                        </div>
                    </div>
